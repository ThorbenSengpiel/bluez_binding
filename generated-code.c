...
static const GDBusArgInfo * const _adapter1_method_info_remove_device_IN_ARG_pointers[] =
{
  &_adapter1_method_info_remove_device_IN_ARG_device.parent_struct,
  NULL
};
...
static const GDBusArgInfo * const _adapter1_method_info_set_discovery_filter_IN_ARG_pointers[] =
{
  &_adapter1_method_info_set_discovery_filter_IN_ARG_filter.parent_struct,
  NULL
};
...
static const GDBusMethodInfo * const _adapter1_method_info_pointers[] =
{
  &_adapter1_method_info_start_discovery.parent_struct,
  &_adapter1_method_info_stop_discovery.parent_struct,
  &_adapter1_method_info_remove_device.parent_struct,
  &_adapter1_method_info_set_discovery_filter.parent_struct,
  NULL
};
...
static const GDBusPropertyInfo * const _adapter1_property_info_pointers[] =
{
  &_adapter1_property_info_address.parent_struct,
  &_adapter1_property_info_name.parent_struct,
  &_adapter1_property_info_alias.parent_struct,
  &_adapter1_property_info_class.parent_struct,
  &_adapter1_property_info_powered.parent_struct,
  &_adapter1_property_info_discoverable.parent_struct,
  &_adapter1_property_info_discoverable_timeout.parent_struct,
  &_adapter1_property_info_pairable.parent_struct,
  &_adapter1_property_info_pairable_timeout.parent_struct,
  &_adapter1_property_info_discovering.parent_struct,
  &_adapter1_property_info_uuids.parent_struct,
  &_adapter1_property_info_modalias.parent_struct,
  NULL
};
 ...
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use adapter1_dup_address() if on another thread.
 *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use adapter1_dup_name() if on another thread.
 *
 * Returns: (transfer none) (nullable): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use adapter1_dup_alias() if on another thread.
 *
 * Returns: (transfer none) (nullable): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use adapter1_dup_uuids() if on another thread.
 *
 * Returns: (transfer none) (nullable): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *const *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use adapter1_dup_modalias() if on another thread.
 *
 * Returns: (transfer none) (nullable): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
  ...
  GParamSpec   *pspec G_GNUC_UNUSED)
{
  ...
  info = (const _ExtendedGDBusPropertyInfo *) _adapter1_property_info_pointers[prop_id - 1];
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL &&
        ...
        _adapter1_schedule_emit_changed (skeleton, info, prop_id, &skeleton->priv->properties[prop_id - 1]);
...
static const GDBusArgInfo * const _device1_method_info_connect_profile_IN_ARG_pointers[] =
{
  &_device1_method_info_connect_profile_IN_ARG_UUID.parent_struct,
  NULL
};
...
static const GDBusArgInfo * const _device1_method_info_disconnect_profile_IN_ARG_pointers[] =
{
  &_device1_method_info_disconnect_profile_IN_ARG_UUID.parent_struct,
  NULL
};
...
static const GDBusMethodInfo * const _device1_method_info_pointers[] =
{
  &_device1_method_info_disconnect.parent_struct,
  &_device1_method_info_connect.parent_struct,
  &_device1_method_info_connect_profile.parent_struct,
  &_device1_method_info_disconnect_profile.parent_struct,
  &_device1_method_info_pair.parent_struct,
  &_device1_method_info_cancel_pairing.parent_struct,
  NULL
};
...
static const GDBusPropertyInfo * const _device1_property_info_pointers[] =
{
  &_device1_property_info_address.parent_struct,
  &_device1_property_info_name.parent_struct,
  &_device1_property_info_alias.parent_struct,
  &_device1_property_info_class.parent_struct,
  &_device1_property_info_appearance.parent_struct,
  &_device1_property_info_icon.parent_struct,
  &_device1_property_info_paired.parent_struct,
  &_device1_property_info_trusted.parent_struct,
  &_device1_property_info_blocked.parent_struct,
  &_device1_property_info_legacy_pairing.parent_struct,
  &_device1_property_info_rssi.parent_struct,
  &_device1_property_info_connected.parent_struct,
  &_device1_property_info_uuids.parent_struct,
  &_device1_property_info_modalias.parent_struct,
  &_device1_property_info_adapter.parent_struct,
  &_device1_property_info_manufacturer_data.parent_struct,
  &_device1_property_info_service_data.parent_struct,
  &_device1_property_info_tx_power.parent_struct,
  &_device1_property_info_services_resolved.parent_struct,
  NULL
};
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use device1_dup_address() if on another thread.
 *
 * Returns: (transfer none) (nullable): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
...
{
    printf("device1_get_address enter");
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use device1_dup_name() if on another thread.
 *
 * Returns: (transfer none) (nullable): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
...
{
    printf("device1_get_name enter");
    fflush(stdout);
    Device1Iface* iface = DEVICE1_GET_IFACE (object);
    printf("device1_get_name get_iface finished");
    fflush(stdout);
    //gchar* ret = "empty";
    const gchar* ret = iface->get_name(object);
    printf("device1_get_name exit");
    fflush(stdout);
    return ret;
}
 ...
 * Since this D-Bus property is both readable and writable, it is meaningful to use this function on both the client- and service-side.
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use device1_dup_alias() if on another thread.
 *
 * Returns: (transfer none) (nullable): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use device1_dup_icon() if on another thread.
 *
 * Returns: (transfer none) (nullable): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use device1_dup_uuids() if on another thread.
 *
 * Returns: (transfer none) (nullable): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *const *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use device1_dup_modalias() if on another thread.
 *
 * Returns: (transfer none) (nullable): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use device1_dup_adapter() if on another thread.
 *
 * Returns: (transfer none) (nullable): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use device1_dup_manufacturer_data() if on another thread.
 *
 * Returns: (transfer none) (nullable): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
GVariant *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use device1_dup_service_data() if on another thread.
 *
 * Returns: (transfer none) (nullable): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
GVariant *
  ...
  GParamSpec   *pspec G_GNUC_UNUSED)
{
  ...
  info = (const _ExtendedGDBusPropertyInfo *) _device1_property_info_pointers[prop_id - 1];
  variant = g_dbus_proxy_get_cached_property (G_DBUS_PROXY (object), info->parent_struct.name);
  if (info->use_gvariant)
    {
      g_value_set_variant (value, variant);
...
{
    printf("device1_proxy_get_name enter");
    fflush(stdout);
    Device1Proxy *proxy = DEVICE1_PROXY (object);
    printf("device1_proxy_get_name 1");
    fflush(stdout);
    GVariant *variant;
  const gchar *value = NULL;
  variant = g_dbus_proxy_get_cached_property (G_DBUS_PROXY (proxy), "Name");
...
{
    printf("device1_proxy_iface_init called \n");
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL &&
          info->emits_changed_signal)
        _device1_schedule_emit_changed (skeleton, info, prop_id, &skeleton->priv->properties[prop_id - 1]);
      g_value_copy (value, &skeleton->priv->properties[prop_id - 1]);
      g_object_notify_by_pspec (object, pspec);
    }
  g_mutex_unlock (&skeleton->priv->lock);
...
{
    printf("device1_skeleton_get_name enter");
    fflush(stdout);
  Device1Skeleton *skeleton = DEVICE1_SKELETON (object);
    printf("device1_skeleton_get_name 1");
    fflush(stdout);
  const gchar *value;
  g_mutex_lock (&skeleton->priv->lock);
  value = g_value_get_string (&(skeleton->priv->properties[1]));
...
{
    printf("device1_skeleton_iface_init called \n");
...
static const GDBusPropertyInfo * const _gatt_service1_property_info_pointers[] =
{
  ...
  &_gatt_service1_property_info_device.parent_struct,
  &_gatt_service1_property_info_primary.parent_struct,
  &_gatt_service1_property_info_characteristics.parent_struct,
  NULL
};
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use gatt_service1_dup_device() if on another thread.
 *
 * Returns: (transfer none) (nullable): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use gatt_service1_dup_characteristics() if on another thread.
 *
 * Returns: (transfer none) (nullable): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *const *
...
static const GDBusArgInfo * const _gatt_characteristic1_method_info_read_value_IN_ARG_pointers[] =
{
  &_gatt_characteristic1_method_info_read_value_IN_ARG_options.parent_struct,
  NULL
};
...
static const GDBusArgInfo * const _gatt_characteristic1_method_info_read_value_OUT_ARG_pointers[] =
{
  &_gatt_characteristic1_method_info_read_value_OUT_ARG_value.parent_struct,
  NULL
};
...
{
  &_gatt_characteristic1_method_info_read_value.parent_struct,
  &_gatt_characteristic1_method_info_write_value.parent_struct,
  &_gatt_characteristic1_method_info_start_notify.parent_struct,
  &_gatt_characteristic1_method_info_stop_notify.parent_struct,
  NULL
};
...
static const GDBusPropertyInfo * const _gatt_characteristic1_property_info_pointers[] =
{
  ...
  &_gatt_characteristic1_property_info_value.parent_struct,
  &_gatt_characteristic1_property_info_notifying.parent_struct,
  &_gatt_characteristic1_property_info_flags.parent_struct,
  &_gatt_characteristic1_property_info_descriptors.parent_struct,
  NULL
};
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use gatt_characteristic1_dup_value() if on another thread.
 *
 * Returns: (transfer none) (nullable): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use gatt_characteristic1_dup_descriptors() if on another thread.
 *
 * Returns: (transfer none) (nullable): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *const *
...
gatt_characteristic1_proxy_get_descriptors (GattCharacteristic1 *object)
{
  ...
  GVariant *variant;
  const gchar *const *value = NULL;
  value = g_datalist_get_data (&proxy->priv->qdata, "Descriptors");
  if (value != NULL)
    return value;
  ...
  if (variant != NULL)
    {
      value = g_variant_get_objv (variant, NULL);
      g_datalist_set_data_full (&proxy->priv->qdata, "Descriptors", (gpointer) value, g_free);
      g_variant_unref (variant);
    }
  return value;
}
...
static const GDBusArgInfo * const _gatt_descriptor1_method_info_read_value_IN_ARG_pointers[] =
{
  &_gatt_descriptor1_method_info_read_value_IN_ARG_options.parent_struct,
  NULL
};
...
static const GDBusArgInfo * const _gatt_descriptor1_method_info_read_value_OUT_ARG_pointers[] =
{
  &_gatt_descriptor1_method_info_read_value_OUT_ARG_value.parent_struct,
  NULL
};
...
static const GDBusArgInfo * const _gatt_descriptor1_method_info_write_value_IN_ARG_pointers[] =
{
  &_gatt_descriptor1_method_info_write_value_IN_ARG_value.parent_struct,
  &_gatt_descriptor1_method_info_write_value_IN_ARG_options.parent_struct,
  NULL
};
...
static const GDBusMethodInfo * const _gatt_descriptor1_method_info_pointers[] =
{
  &_gatt_descriptor1_method_info_read_value.parent_struct,
  &_gatt_descriptor1_method_info_write_value.parent_struct,
  NULL
};
...
static const GDBusPropertyInfo * const _gatt_descriptor1_property_info_pointers[] =
{
  &_gatt_descriptor1_property_info_uuid.parent_struct,
  &_gatt_descriptor1_property_info_characteristic.parent_struct,
  &_gatt_descriptor1_property_info_value.parent_struct,
  NULL
};
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use gatt_descriptor1_dup_uuid() if on another thread.
 *
 * Returns: (transfer none) (nullable): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use gatt_descriptor1_dup_characteristic() if on another thread.
 *
 * Returns: (transfer none) (nullable): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
 ...
 * Since this D-Bus property is readable, it is meaningful to use this function on both the client- and service-side.
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use gatt_descriptor1_dup_value() if on another thread.
 *
 * Returns: (transfer none) (nullable): The property value or %NULL if the property is not set. Do not free the returned value, it belongs to @object.
 */
const gchar *
  ...
  GParamSpec   *pspec G_GNUC_UNUSED)
{
  ...
  info = (const _ExtendedGDBusPropertyInfo *) _gatt_descriptor1_property_info_pointers[prop_id - 1];
  variant = g_dbus_proxy_get_cached_property (G_DBUS_PROXY (object), info->parent_struct.name);
  if (info->use_gvariant)
    {
      g_value_set_variant (value, variant);
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL &&
          info->emits_changed_signal)
        _gatt_descriptor1_schedule_emit_changed (skeleton, info, prop_id, &skeleton->priv->properties[prop_id - 1]);
      g_value_copy (value, &skeleton->priv->properties[prop_id - 1]);
      g_object_notify_by_pspec (object, pspec);
    }
  g_mutex_unlock (&skeleton->priv->lock);
 ...
 *
 * Returns: (transfer full) (nullable): A #Adapter1 that must be freed with g_object_unref() or %NULL if @object does not implement the interface.
 */
 ...
 *
 * Returns: (transfer full) (nullable): A #Device1 that must be freed with g_object_unref() or %NULL if @object does not implement the interface.
 */
 ...
 *
 * Returns: (transfer full) (nullable): A #GattService1 that must be freed with g_object_unref() or %NULL if @object does not implement the interface.
 */
 ...
 *
 * Returns: (transfer full) (nullable): A #GattCharacteristic1 that must be freed with g_object_unref() or %NULL if @object does not implement the interface.
 */
 ...
 *
 * Returns: (transfer full) (nullable): A #GattDescriptor1 that must be freed with g_object_unref() or %NULL if @object does not implement the interface.
 */
 ...
 *
 * Returns: (transfer none) (nullable): A #Adapter1 or %NULL if @object does not implement the interface. Do not free the returned object, it is owned by @object.
 */
 ...
 * It is not safe to use the returned object if you are on another thread than the one where the #GDBusObjectManagerClient or #GDBusObjectManagerServer for @object is running.
 *
 * Returns: (transfer none) (nullable): A #Device1 or %NULL if @object does not implement the interface. Do not free the returned object, it is owned by @object.
 */
 ...
 * It is not safe to use the returned object if you are on another thread than the one where the #GDBusObjectManagerClient or #GDBusObjectManagerServer for @object is running.
 *
 * Returns: (transfer none) (nullable): A #GattService1 or %NULL if @object does not implement the interface. Do not free the returned object, it is owned by @object.
 */
 ...
 * It is not safe to use the returned object if you are on another thread than the one where the #GDBusObjectManagerClient or #GDBusObjectManagerServer for @object is running.
 *
 * Returns: (transfer none) (nullable): A #GattCharacteristic1 or %NULL if @object does not implement the interface. Do not free the returned object, it is owned by @object.
 */
 ...
 * It is not safe to use the returned object if you are on another thread than the one where the #GDBusObjectManagerClient or #GDBusObjectManagerServer for @object is running.
 *
 * Returns: (transfer none) (nullable): A #GattDescriptor1 or %NULL if @object does not implement the interface. Do not free the returned object, it is owned by @object.
 */
 ...
 * @interface_: (nullable): A #Adapter1 or %NULL to clear the interface.
 *
 ...
 * @object: A #ObjectSkeleton.
 * @interface_: (nullable): A #Device1 or %NULL to clear the interface.
 *
 ...
 * @object: A #ObjectSkeleton.
 * @interface_: (nullable): A #GattService1 or %NULL to clear the interface.
 *
 ...
 * @object: A #ObjectSkeleton.
 * @interface_: (nullable): A #GattCharacteristic1 or %NULL to clear the interface.
 *
 ...
 * @object: A #ObjectSkeleton.
 * @interface_: (nullable): A #GattDescriptor1 or %NULL to clear the interface.
 *
